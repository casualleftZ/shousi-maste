...
public class DBOPenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL ("create table onlineorder(or_id int primary key,u_id int,or_phone varchar(11),d_id int,or_sum string,or_time varchar(20),or_memo varchar(30))");//在线预订表
        db.execSQL("create table login1(zt_id int primary key,zt int,u_id int,or_id int)");
    }
